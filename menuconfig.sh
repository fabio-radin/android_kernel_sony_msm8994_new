...
DEFAULT_DEVICE=karin

# default target name
DEFAULT_TARGET=kitakami

# directory containing cross-compile arm64 toolchain (change this!)
TOOLCHAIN=/opt/android/lineage_18.1/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/
...
export ARCH=arm64
export CROSS_COMPILE=$TOOLCHAIN/bin/aarch64-linux-androidkernel-
